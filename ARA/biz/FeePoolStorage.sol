...
contract FeePoolStorage is Ownable, Deadline {
    ...
    {
        require(index < FEE_PERIOD_LENGTH, "FeePoolStorage: index exceeds the FEE_PERIOD_LENGTH");
    ...
    beforeDeadline
    {
        require(accounts.length == ratios.length, "FeePoolStorage: Length mismatch");
    ...
    {
        require(msg.sender == feePool, "FeePoolStorage: Only the FeePool contract can perform this action");
        _;
    }
